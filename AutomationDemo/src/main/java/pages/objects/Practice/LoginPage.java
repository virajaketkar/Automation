package pages.objects.Practice;
...
public class LoginPage extends BaseClass {
	...
	public static final String CLICKME ="button1" ;
    ...
    public WebElement clickmebutton() throws Exception {
		
		element = getElementByID(CLICKME);
